...
//
//   node scripts/listing.mjs packages/<id>/<version>.json --tags "Dark,Phone" [--preview <https url>]
//
...
if (!file) { console.error('usage: node scripts/listing.mjs packages/<id>/<version>.json [--tags a,b] [--preview url] [--project url]'); process.exit(1) }
const options = {}
